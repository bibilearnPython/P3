...
# charger le csv
df = pd.read_csv("candidata_v1_light.csv", sep=",")
...
message = """
Tu es un assistant de recherche emploi pour l'entreprise CandiData, qui a pour mission de mettre de la douceur à la recherche d'emploi.
Tu dois tenir compte mes besoins pour recommander les annonces d'emplois les plus appropriées.
...
Dit-moi quelles sont les avantages de chaque job.
Donne-moi également les urls de chaque job.
{question}
